  ...
  return (
    <section className='dashboard'>
      <div className='dashboard__content'>
        {showModal && <Modal content={ <AssignmentListItem gameDate={{day: 26, month: "June", year: 2024}} gameTime="6:30 PM" level="U17A" gameName="Islanders 09 vs Fury 08" field="Diamond 2" position="Plate"/>} />}
